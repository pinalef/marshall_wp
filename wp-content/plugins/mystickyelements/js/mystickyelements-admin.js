( function( $ ) {
	...
	$(document).ready(function(){
		...
		$( ".social-channel-view-desktop" ).live( "click", function() {
		...
		$( ".social-channel-view-mobile" ).live( "click", function() {
		...
		$('.social-custom-icon-upload-button').live( 'click', function(e) {
			...
			var image = wp.media({
				...
				.on('select', function(e){
					...
					$("#mystickyelements-custom_one-custom-icon").prop("selectedIndex", 0).trigger('change');
					...
					$('ul.myStickyelements-preview-ul li span.social-' + social_channel).append( '<img src="' + image_url + '" width="40" height="40"/><span class="mystickyelements-icon-below-text" style="'+ $social_icon_text_size_style +'">'+ $social_icon_text +'</span>' );
		...
		$( '.myStickyelements-icon-text-input' ).live( 'keyup', function(){
		...
		$( '.myStickyelements-icon-text-size' ).live( 'keyup', function(){
		...
		$( '[name="contact-form[text_in_tab]"]' ).live( 'keyup', function(){
